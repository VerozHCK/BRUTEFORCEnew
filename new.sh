...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" VEROZ HACK TEAM  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" F4r0ZZ"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.zayzenL] [ZAYZEN] [MR.99]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AGHh]"$i" |"
